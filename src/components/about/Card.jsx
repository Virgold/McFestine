...
const Card = (props) => {
  ...
  return (
    <div className={`lg:w-1/4 md:w-1/3 w-5/6 h-[345px] ${rotate}`}>
      <div className={`py-4 px-8 h-full w-full bg-[#FDFDFD] flex items-center border border-[#B3B3B3] rounded-lg hover:shadow-xl transition duration-500 ${negateRotate} bg-white `}>
